...
class _LoginWidgetState extends State<LoginWidget> {
  ...
  void initState() {
    ...
    _model.inputPassController ??= TextEditingController();
  }
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: FlutterFlowTheme.of(context).federalBlue,
                    ...
                    children: [
                      ...
                      Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 16.0),
                        child: TextFormField(
                          controller: _model.inputPassController,
                          obscureText: !_model.inputPassVisibility,
                          decoration: InputDecoration(
                            labelText: 'Password',
                            hintStyle: FlutterFlowTheme.of(context)
                                .bodyLarge
                          ...
                          validator: _model.inputPassControllerValidator
                              .asValidator(context),
                        ),
                      ),
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            final user = await authManager.signInWithEmail(
                              ...
                              _model.inputPassController.text,
                            );
                            if (user == null) {
                              return;
                            }
