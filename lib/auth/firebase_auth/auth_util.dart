...
DocumentReference? get currentUserReference =>
    loggedIn ? ComplaintsRecord.collection.doc(currentUser!.uid) : null;

ComplaintsRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : ComplaintsRecord.getDocument(ComplaintsRecord.collection.doc(uid))
              .handleError((_) {}),
    )
